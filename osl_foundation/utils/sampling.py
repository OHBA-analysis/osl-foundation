...
def sample_from_logits(logits: tf.Tensor, method: str, **kwargs) -> tf.Tensor:
    """
    ...
    **kwargs
        Additional arguments for the sampling method.
    ...
    """
    if method == "top_k":
        sampled_tokens = top_k_sampling(logits, **kwargs)
    elif method == "top_p":
        sampled_tokens = top_p_sampling(logits, **kwargs)
    elif method == "argmax":
