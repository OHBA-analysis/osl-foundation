...
real_data_dir = f"{dev_dir}/results/osl-foundation/camcan_spring23/src"

do_chan_att = True
generator_dir = f"{dev_dir}/results/osl-foundation/camcan_spring23/generator_ca{do_chan_att}"

with open(f"{generator_dir}/generated_data_p99.pkl", "rb") as f:
    data = pickle.load(f)
